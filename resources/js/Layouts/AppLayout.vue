...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-purple-400 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('home')" class="flex font-xl font-bold">
                                    Bukuku
                                </Link>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <div class="flex items-center space-x-10 relative">
                                    <InertiaLink :href="route('category')" class="hover:text-gray-100">
                                        Category
                                    </InertiaLink>
                                    <InertiaLink :href="route('addBook')" class="hover:text-gray-100">
                                        Sell/Donate
                                    </InertiaLink>
                                    <InertiaLink :href="route('contactus')" class="hover:text-gray-100">
                                        Contact Us
                                    </InertiaLink>
                                    <div class="hidden sm:flex sm:items-center sm:ml-6">
